...
if __name__ == "__main__":
    ...
    if asset_type == "stocks":
        ...
        returns = pd.read_csv("data/crypto_data.csv", index_col=0)  # Use the first column as index
    elif asset_type == "forex":
        returns = pd.read_csv("data/forex_returns.csv", index_col=0)  # Use the first column as index
    else:
